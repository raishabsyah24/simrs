            ...
            <div class="invoice-bills mt-2">
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        @endforelse
                        <tr>
                            <td colspan="7" class="text-right"><h5>Grand Total</h5></td>
                            <td colspan="2"><h5>{!! formatAngka($grand_total, true) !!}</h5></td>
                        </tr>

                        <tr>
                            <td colspan="9" class="text-right text-capitalize"><h5>{!! terbilangRupiah($grand_total) !!}</h5></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
