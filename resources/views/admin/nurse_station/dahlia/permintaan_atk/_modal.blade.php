    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">PERMINTAAN ATK DAHLIA</h5>
            ...
            <div class="modal-body">
                ...
                <form class="image-upload" method="post" action="{{route('ns.permintaan-input-atk-dahlia')}}" enctype="multipart/form-data">
                    @csrf
                   ...
                   <div class="row">
                    ...
                    <div class="row">
                        ...
                        <input type="text" class="form-control" id="default-1-03" disabled value="ATK">
                    </div>
