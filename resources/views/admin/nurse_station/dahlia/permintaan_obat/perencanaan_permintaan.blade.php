        ...
        <div class="container-fluid">
            <div class="nk-content-inner">
                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">DAHLIA</h3>
                            </div>
                        </div>
                ...
                <div class="nk-block fetch-data d-none">
                        @include('admin.nurse_station.dahlia.permintaan_obat.fetch_permintaan')
...
@includeIf('admin.nurse_station.dahlia.permintaan_obat._modal')
@endsection
