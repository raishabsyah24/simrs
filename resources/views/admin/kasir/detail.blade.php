            ...
            <div class="nk-content-inner">
                <div class="nk-content-body">
                    ...
                    <div id="identitas-pasien"
                        class="accordion mt-4 border border-right-0 border-top-0 rounded-top border-primary">
                    ...
                    <div class="nk-tb-list is-separate my-3">
                        ...
                        @forelse ($layanan as $item)
                            <div class="nk-tb-item">
                                ...
                                <div class="nk-tb-col tb-col-md">
                                    <p class="text-right pr-3 fs-18px ff-mono">{{ formatAngka($item->subtotal, true) }}
                                    </p>
                                </div>
                            </div>
                        @empty
                        ...
                        <div class="nk-tb-item">
                            ...
                            <div class="nk-tb-col tb-col-md">
                                <h4 class="text-right pr-3 fs-18px ff-mono">
                                    {{ formatAngka(totalTagihan($kasir->id), true) }}</h4>
                            </div>
                        </div>
                        {{-- End Grand Total --}}
                    </div>
