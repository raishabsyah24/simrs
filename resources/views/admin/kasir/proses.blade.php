                ...
                <div class="nk-content-body">
                    ...
                    <div class="nk-block-head nk-block-head-sm float-right">
                        <div class="nk-block-head nk-block-head-lg wide-sm">
                            <div class="nk-block-head-content">
                                <div class="fw-normal">
                                    <button onclick="addForm(`{{ route('kasir.tambah-deposit', $kasir->id) }}`)" class="btn btn-success shadow py-3 mr-2">Tambah Deposit Pasien</button>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="nk-tb-col tb-col-md w-25">
                                <div class="form-control-wrap">
                                    <div class="form-text-hint">
                                        <span class="overline-title"><h4 class="pt-1">%</h4></span>
                                    </div>
                                    <input name="diskon" type="number" class="form-control form-control-lg" autocomplete="off" onkeyup="setTotal(`{{ route('kasir.update-tagihan', $kasir->id) }}`, this)">
                                </div>
                            </div>
                        </div>
{{--                        End Diskon--}}
                        ...
                        <div class="nk-tb-item">
                            ...
                            <div class="nk-tb-col tb-col-md w-25">
                                <div class="form-control-wrap">
                                    ...
                                    <input name="pajak" autocomplete="off" type="number" class="form-control form-control-lg" onkeyup="setTotal(`{{ route('kasir.update-tagihan', $kasir->id) }}`, this)">
                                </div>
                            </div>
                        </div>
{{--                        End Pajak--}}
                            ...
                            <div class="nk-tb-item">
                                ...
                                <div class="nk-tb-col tb-col-md">
                                    <div class="form-control-wrap">
                                        <select class="form-control-lg form-control form-select select2" style="position:absolute;"
                                ...
                                <div class="nk-tb-col tb-col-md w-35">
                                    <div class="form-control-wrap">
                                        <div class="input-group">
                                            ...
                                            <input type="text" autocomplete="off" onkeyup="bayar(this)" name="dibayar" class="form-control form-control-lg">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    {{--                        End Grand Total--}}
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-md-3">
                            <button onclick="simpanTransaksi(this.form)" class="btn btn-lg btn-success"><span class="text-simpan">Simpan</span>
                                <span class="loading-simpan d-none ml-2 spinner-border spinner-border-sm" role="status"
                                      aria-hidden="true"></span> <em class="ml-1 icon ni ni-check-round-cut"></em></button>
                        </div>
                    </div>
                    </form>
                </div>
