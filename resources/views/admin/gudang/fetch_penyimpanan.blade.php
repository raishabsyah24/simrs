<div class="nk-tb-list is-separate mb-3">
        <div class="nk-tb-item nk-tb-head">
            ...
            <div class="nk-tb-col"><span class="sub-text">Penyimpanan</span></div>
            <div class="nk-tb-col"><span class="sub-text">Nama Obat</span></div>
            <div class="nk-tb-col"><span class="sub-text">Penerimaan PO</span></div>
            <div class="nk-tb-col"><span class="sub-text">Penanggung Jawab PO</span></div>
            <div class="nk-tb-col"><span class="sub-text">Proses</span></div>
            <div class="nk-tb-col"><span class="sub-text">Detail</span></div>
