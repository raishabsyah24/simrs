                        ...
                        <div class="header-wrap">
                            ...
                            <nav class="header-menu" data-content="mainNav">
                                <ul class="menu-list ml-lg-auto">
                                        ...
                                        <div class="menu-sub">
                                            <ul class="menu-list">
                                                <li class="menu-item"><a href="html/index.html"
                                                        class="menu-link">Landing Page - v1</a></li>
                                                <li class="menu-item"><a href="html/index-v2.html"
                                                        class="menu-link">Landing Page - v2</a></li>
                                                <li class="menu-item"><a href="html/index-v3.html"
                                                        class="menu-link">Landing Page - v3</a></li>
                                                <li class="menu-item"><a href="html/index-v4.html"
                                                        class="menu-link">Landing Page - v4</a></li>
                                                <li class="menu-item"><a href="html/index-v5.html"
                                                        class="menu-link">Landing Page - v5</a></li>
                                                <li class="menu-item"><a href="html/index-v6.html"
                                                        class="menu-link">Landing Page - v6</a></li>
                                            </ul>
                                        </div>
                                    </li>
                                    <li class="menu-item has-sub">
                                                    ...
                                                    <div class="menu-sub">
                                                        <ul class="menu-list">
                                                            <li class="menu-item"><a
                                                                    ...
                                                                    class="menu-link" target="_blank">Login /
                                                                    Signin</a></li>
                                                            <li class="menu-item"><a
                                                            ...
                                                            <li class="menu-item"><a
                                                                    ...
                                                                    class="menu-link" target="_blank">Register /
                                                                    Signup</a></li>
                                                            <li class="menu-item"><a
                                                            ...
                                                            <li class="menu-item"><a
                                                                    ...
                                                                    class="menu-link" target="_blank">Forgot
                                                                    Password</a></li>
                                                            <li class="menu-item"><a
                                                    ...
                                                    <div class="menu-sub">
                                                        <ul class="menu-list">
                                                            <li class="menu-item"><a
                                                                    ...
                                                                    target="_blank" class="menu-link">404
                                                                    Classic</a></li>
                                                            <li class="menu-item"><a
                                                            ...
                                                            <li class="menu-item"><a
                                                                    ...
                                                                    target="_blank" class="menu-link">504
                                                                    Classic</a></li>
                                                            <li class="menu-item"><a
                                    ...
                                    <li class="menu-item"><a href="#feature"
                                            class="menu-link nav-link">Features</a></li>
                                    <li class="menu-item"><a href="#faqs" class="menu-link nav-link">Faqs</a></li>
                                </ul>
                                <ul class="menu-btns">
                                    <li>
                                        <a href="https://1.envato.market/e0y3g" target="_blank"
                                            class="btn btn-primary btn-lg">Download the app</a>
                                    </li>
                                </ul>
                            </nav><!-- .nk-nav-menu -->
                        </div><!-- .header-warp-->
                            ...
                            <div class="col-lg-7 col-md-10">
                                <div class="header-caption">
                                    ...
                                    <ul class="header-action btns-inline">
                                        <li><a href="#" class="btn btn-primary btn-lg"><span>Getting Started</span></a>
                                        </li>
                                ...
                                <div class="review-content card card-shadow round-xl">
                                    <div class="card-inner card-inner-lg">
                                        ...
                                        <div class="review-text">
                                            <p>Regularly updated to add new features. Developer has been responsive when
                                                contacted, not that I have needed to except to make suggestions .</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="review">
                                <div class="review-content card card-shadow round-xl">
                                    <div class="card-inner card-inner-lg">
                                        ...
                                        <div class="review-text">
                                            <p>Is everything cool, but I need support from you to use it, because i
                                                belived is a wordpress theme, and is not to! How I can do it to work for
                                                me</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="review">
                                <div class="review-content card card-shadow round-xl">
                                    <div class="card-inner card-inner-lg">
                                        ...
                                        <div class="review-text">
                                            <p>Praising pain was bSed ut perspiciatis unde omnis iste natus error sit
                    ...
                    <div class="row g-gs align-items-center">
                        <div class="col-lg-5">
                            <div class="text-block is-dark pr-xl-5">
                                ...
                                <p class="lead">An overview of DashLite – is fully clean and premium designed
                                    admin template.</p>
                            </div><!-- .text-block -->
                        </div><!-- .col -->
                        <div class="col-lg-7">
                    ...
                    <div class="row justify-content-center text-center">
                        <div class="col-lg-6">
                            <div class="section-head">
                                ...
                                <p>Got a question? We've got answers. If you have some other questions, Who are in
                                    extremely love with eco friendly system.</p>
                            </div><!-- .section-head -->
                        </div><!-- .col -->
                    </div><!-- .row -->
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="accordion accordion-s1 card card-shadow border-0 round-xl" id="accordion">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div class="accordion-body collapse" id="accordion-item-5"
                                        data-parent="#accordion">
                                        <div class="accordion-inner">
                                            <p>Absolutely! We work with top payment companies which guarantees your
                                                safety and security. All billing information is stored on our payment
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-10">
                            <div class="row align-items-center g-0">
                                        ...
                                        <div class="card-inner card-inner-xl">
                                            <div class="text-block">
                                                ...
                                                <ul class="list list-nostyle fs-16px">
                                                    ...
                                                    <li class="note text-warning">+ All future update releases for Free
                                                    </li>
                                                </ul>
                                                <ul class="btns-inline">
                                                    <li><a href="https://1.envato.market/e0y3g" target="_blank"
                                                            class="btn btn-xl btn-primary">Purchase Now for $24</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-5">
                                    <div
                                        class="card card-shadow round-xl ml-lg-n7 ml-md-n5 mx-4 mr-md-0 mt-md-0 mt-n4">
                                        <div class="card-inner card-inner-lg">
                                            <div class="form-block">
                                                ...
                                                <form action="#" class="form-submit">
                                                    <div class="row g-4">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label class="form-label" for="email">Enter Your
                                                                    Email</label>
                                                                <div class="form-control-wrap">
                                                                    <input type="text"
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label class="form-label" for="question">Your
                                                                    Question</label>
                                                                <div class="form-control-wrap">
